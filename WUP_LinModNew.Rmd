...
summary.lm(model.3)
```
We have some important statistics. We have multiple R square and Residual standard Error for SIMS, ARM and GRIP. We have adjusted R square of 0.535 and multiple r square are 0.542. As you put more things into the model the result is lower.
